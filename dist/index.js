...
class BaseAccessory {
  constructor(log, accessoryConfig, platform) {
    ...
    infoService.setCharacteristic(Characteristic.Manufacturer, this.manufacturer).setCharacteristic(Characteristic.Model, this.model); // store the infoService in the Accessory instance
...
class GenericSwitch extends BaseAccessory {
  constructor(log, accessoryConfig, platform) {
    super(log, accessoryConfig, platform);
  }
